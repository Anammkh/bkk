...
<html lang="en">
    <head>
        ...
        <title>BKK SMK N Kandeman</title>
...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            <li
                class="sidebar-item @if(request()->route()->uri == 'home') active @endif">
            ...
            <li
            class="sidebar-item ">
            <a href="{{ route('pelamar') }}" class='sidebar-link'>
                <i class="bi bi-collection-fill"></i>
                <span>Pelamar</span>
            </a>
           <li
                class="sidebar-item @if(request()->route()->uri == 'jurusan') active @endif ">
                <a href="{{ route('jurusan') }}"class='sidebar-link'>
                    <i class="bi bi-grid-fill"></i>
                    <span>Jurusan</span>
                </a>
            </li>
            <li
            class="sidebar-item @if(request()->route()->uri == 'lamaran') active @endif ">
            ...
            <li
            class="sidebar-item @if(request()->route()->uri == 'mitra') active @endif ">
            <a href="{{ route('mitra') }}" class='sidebar-link'>
                <i class="bi bi-grid-fill"></i>
                <span>Mitra</span>
            </a>
        </li>
        <li
        class="sidebar-item  @if(request()->route()->uri == 'lowongan') active @endif">
        <a href="{{ route('lowongan') }}" class='sidebar-link'>
            <i class="bi bi-grid-fill"></i>
            <span>Lowongan</span>
        </a>
    </li>
    <li
    class="sidebar-item  @if(request()->route()->uri == 'user') active @endif">
